...
function EngageCard({
  ...
  const cardClass =
    'bg-white/55 backdrop-blur-sm p-6 sm:p-8 md:p-10 space-y-3 sm:space-y-4 border border-[#C9BCB0]/50 hover:border-[#4F5D4C]/40 transition-colors duration-300 block h-full';

  if (external) {
    return (
      <a href={to} className={cardClass}>
        <h3 className="font-serif text-xl sm:text-2xl text-[#3A3A36]" style={serifHeadingMedium}>
          {title}
        </h3>
  ...
  return (
    <div>
      ...
      <section className="relative min-h-[75svh] md:min-h-[88vh] flex items-end md:items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 lg:px-14 w-full py-14 sm:py-16 md:py-20">
          <div className="max-w-[720px] space-y-4 sm:space-y-6">
            <p className="font-sans text-[13px] sm:text-[15px] tracking-[0.03em] text-white/90 leading-snug">
              Founder of Alice the Time Bender. Senior Executive Advisor. Global Speaker.
            </p>
            <h1
              className="font-serif text-4xl sm:text-5xl md:text-6xl lg:text-[68px] leading-[1.08] text-white"
              style={{ ...serifHeading, letterSpacing: '-0.02em' }}
            >
              Rasmus Nutzhorn
            </h1>
            <p className="font-sans text-base sm:text-lg md:text-[19px] text-white/92 leading-relaxed">
            ...
            <p className="font-sans text-[15px] sm:text-base md:text-[17px] text-white/85 leading-relaxed">
      ...
      <section className="py-16 sm:py-20 md:py-32 px-5 sm:px-6 lg:px-14 bg-[#F2EFE9]">
        <div className="max-w-[660px] mx-auto space-y-6">
          <h2 className="font-serif text-2xl sm:text-3xl lg:text-[40px] text-[#3A3A36] leading-tight" style={serifHeading}>
            Some Decisions Need More Than Advice
          </h2>
      ...
      <section className="py-16 sm:py-20 md:py-32 px-5 sm:px-6 lg:px-14 bg-[#F8F7F4]">
      ...
      {/* Career pillars */}
      <section className="py-16 sm:py-20 md:py-32 px-5 sm:px-6 lg:px-14 bg-[#E6E0D8]">
        <div className="max-w-7xl mx-auto space-y-12 lg:space-y-16">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-px bg-[#3A3A36]/10">
            {careerPillars.map(({ title, text }) => (
              <div key={title} className="bg-[#E6E0D8] px-5 py-6 sm:px-8 sm:py-8 md:px-9">
      ...
      {/* Grounded in Reality */}
      <section className="py-16 sm:py-20 md:py-32 px-5 sm:px-6 lg:px-14 bg-[#D8D1C7] text-center">
        <p
          className="font-serif text-2xl sm:text-3xl md:text-4xl text-[#3A3A36] leading-snug max-w-3xl mx-auto px-1"
      ...
      {/* Selected Experience */}
      <section className="py-16 sm:py-20 md:py-32 px-5 sm:px-6 lg:px-14 bg-[#F8F7F4] overflow-hidden">
        <div className="max-w-7xl mx-auto space-y-12 lg:space-y-16">
          ...
          >
            <div
              className="rn-marquee-track flex gap-20 w-max"
              style={{ animation: 'rn-marquee 32s linear infinite' }}
            >
              {[...featuredClients, ...featuredClients].map((name, i) => (
                <span
                  key={`${name}-${i}`}
                  className="rn-marquee-item font-serif text-2xl text-[#3A3A36]/70 whitespace-nowrap"
                  style={serifHeading}
                >
                  {name}
                </span>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10 lg:gap-14 text-left">
      ...
      {/* Alice */}
      <section className="py-20 sm:py-24 md:py-32 px-5 sm:px-6 lg:px-12 bg-[#3A3A36] text-center">
        <div className="max-w-2xl mx-auto space-y-5 sm:space-y-6">
          <h2 className="font-serif text-2xl sm:text-3xl lg:text-4xl text-[#F8F7F4] leading-tight" style={serifHeading}>
            Alice
          </h2>
      ...
      <section className="py-16 sm:py-20 md:py-32 px-5 sm:px-6 lg:px-14 bg-[#F2EFE9] text-center">
        <h2 className="font-serif text-2xl sm:text-3xl lg:text-[40px] text-[#3A3A36] leading-tight mb-5 sm:mb-6" style={serifHeading}>
          Begin a Conversation
        </h2>
        <p className="font-sans text-base sm:text-lg text-[#3A3A36]/80 leading-relaxed max-w-[620px] mx-auto mb-7 sm:mb-9 px-1">
