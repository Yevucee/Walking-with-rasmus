...
const subNavItems = [
  ...
  { id: 'about', label: 'Rasmus' },
  { id: 'contact', label: 'Begin' },
];

export function WalkingWithRasmusPage() {
  usePageTitle('Walking with Rasmus');
    ...
    <div>
      <div className="px-6 lg:px-12 py-12 bg-[#F8F7F4] border-b border-[#D8D4CE]/40">
        <div className="max-w-7xl mx-auto space-y-2">
          ...
          <p className="font-sans text-[#3A3A36]/65 text-base md:text-lg">
            A signature experience within the Rasmus Nutzhorn world.
          </p>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-[#3A3A36]/80 font-sans text-lg leading-relaxed">
                <p>Not every meeting needs continuous dialogue.</p>
                <p>
        ...
        <div className="max-w-7xl mx-auto space-y-16">
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-6">
              <h3 className="font-serif text-3xl lg:text-4xl text-[#3A3A36]" style={serifHeadingMedium}>
                Switzerland
              </h3>
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-6 order-1 md:order-2">
              ...
              <div className="space-y-4 text-[#3A3A36]/80 font-sans text-lg leading-relaxed">
                <p>A slower, quieter terrain shaped by weather, rhythm, and solitude.</p>
                <p>
      ...
      <section className="py-32 px-6 lg:px-12 bg-[#F8F7F4]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {[
              { title: 'Quiet', text: 'Walking without pressure to speak.' },
              { title: 'Reflection', text: 'Time for thought, pause, observation.' },
              { title: 'Conversation', text: 'When useful, serious discussion emerges naturally.' },
            ].map(({ title, text }) => (
              <div key={title} className="space-y-4 text-center">
                <h4 className="font-serif text-2xl text-[#3A3A36]" style={serifHeadingMedium}>
                  {title}
                </h4>
                <p className="text-[#3A3A36]/80 font-sans leading-relaxed">{text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 px-6 lg:px-12 bg-[#E0DCD5]">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { title: 'Before', text: 'A private preparation exchange defines intention.' },
              { title: 'During', text: 'Walking, silence, conversation, pauses, meals.' },
              { title: 'After', text: 'A clearer sense of next steps, often without forcing conclusions.' },
            ].map(({ title, text }) => (
              <div key={title} className="space-y-4 p-8 border-l-2 border-[#4F5D4C]">
                <h4 className="font-serif text-2xl text-[#3A3A36]" style={serifHeadingMedium}>
                  {title}
                </h4>
                <p className="text-[#3A3A36]/80 font-sans leading-relaxed">{text}</p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-[#3A3A36]/80 font-sans text-lg leading-relaxed">
                <p>Rasmus works with people and organisations where judgement, trust, and perspective matter.</p>
                <p>This format creates a different setting for time that should not feel transactional.</p>
                <p>The emphasis is not performance, but quality of thought.</p>
              </div>
              <Link
                to="/about"
